...
export default function StartPage({ sessionId, formData: defaultFormData }: StartPageProps) {
        ...
        <form onSubmit={(e) => {
            ...
            <div className={'flex flex-col gap-y-3'}>
                <div className={'flex gap-x-3'}>
                    <div><TextInput placeholder="Full Name"
                                  autoComplete={'off'}
                                  className={'inline'}
                                  value={data.fullName}
                    ...
                    <div>
                        <TextInput placeholder="Date" value={data.date}
                ...
                <div>
                    <TextInput placeholder="Address Line 1" className="w-full"
                           autoComplete={'off'}
                ...
                <div>
                    <TextInput placeholder="Address Line 2" className="w-full" autoComplete={'off'}
                ...
                <div className={'flex gap-x-3'}>
                    <div className={'w-full'}>
                        <TextInput placeholder="City" className="inline" autoComplete={'off'}
                    ...
                    <div className={'w-full'}>
                        <TextInput placeholder="Zip Code" className="inline" autoComplete={'off'}
                ...
                <div>
                    <TextInput type="tel" placeholder="Phone Number" className="w-full" autoComplete={'off'}
                               value={data.phone}
                ...
                <div>
                    <TextInput placeholder="Alternate Contact Name" autoComplete={'off'}
                               className="w-full"
                               value={data.alternateContactName}
                               onChange={(e) => setData('alternateContactName', e.target.value)}
                    />
                    <InputError message={errors.alternateContactName} className="mt-2" />
                </div>
                <div>
                    <TextInput type="tel" placeholder="Alternate Phone Number" autoComplete={'off'}
                               className="w-full"
                               value={data.alternateContactNumber}
                               onChange={(e) => setData('alternateContactNumber', e.target.value)}
                    />
                    <InputError message={errors.alternateContactNumber} className="mt-2" />
                </div>
                <div>
                    <TextInput placeholder="Children's Name" className="w-full" autoComplete={'off'}
